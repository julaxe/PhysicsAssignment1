 ...
 * @param is_centered
 */
ResetButton::ResetButton(const std::string& image_path, std::string button_name, const GameObjectType type,
 ...
 * @return void
 */
void ResetButton::setAlpha(const Uint8 alpha)
{
	m_alpha = alpha;
}
 ...
 * @return void
 */
void ResetButton::setActive(const bool value)
{
	m_active = value;
}
